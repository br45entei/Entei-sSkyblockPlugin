...
public enum Material_1_12_2 {
	...
	private static Material_1_12_2[] byId = new Material_1_12_2[383];
	private final static Map<String, Material_1_12_2> BY_NAME = Maps.newHashMap();
	private final int maxStack;
	private final short durability;
	
	private Material_1_12_2(final int id) {
		this(id, 64);
	}
	
	private Material_1_12_2(final int id, final int stack) {
		this(id, stack, MaterialData.class);
	}
	
	private Material_1_12_2(final int id, final int stack, final int durability) {
		this(id, stack, durability, MaterialData.class);
	}
	
	private Material_1_12_2(final int id, final Class<? extends MaterialData> data) {
		this(id, 64, data);
	}
	
	private Material_1_12_2(final int id, final int stack, final Class<? extends MaterialData> data) {
		this(id, stack, 0, data);
	}
	
	private Material_1_12_2(final int id, final int stack, final int durability, final Class<? extends MaterialData> data) {
		this.id = id;
		this.durability = (short) durability;
		this.maxStack = stack;
		// try to cache the constructor for this material
		try {
			this.ctor = data.getConstructor(Material.class, byte.class);
	...
	public MaterialData getNewData(final byte raw) {
		try {
			return this.ctor.newInstance(Material.getMaterial(this.name(), true), Byte.valueOf(raw));
	 ...
	 * @deprecated Magic value */
	@Deprecated
	public static Material_1_12_2 getMaterial(final int id) {
	 ...
	 * @return Material if found, or null */
	public static Material_1_12_2 getMaterial(final String name) {
	 ...
	 * @param name Name of the material to get
	 * @return Material if found, or null */
	public static Material_1_12_2 matchMaterial(final String name) {
		Validate.notNull(name, "Name cannot be null");
		
		Material_1_12_2 result = null;
	...
	static {
		for(Material_1_12_2 material : values()) {
